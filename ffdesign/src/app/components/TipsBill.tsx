  ...
  return (
    <div className="relative cursor-pointer hover:scale-105 transition-transform duration-200">
      <svg width="80" height="36" viewBox="0 0 80 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* 100 in corners */}
        <text x="8" y="14" fontFamily="Space Mono, monospace" fontSize="10" fontWeight="bold" fill="#2D4A1F">
          100
        </text>
        <text x="58" y="30" fontFamily="Space Mono, monospace" fontSize="10" fontWeight="bold" fill="#2D4A1F">
          100
        </text>
        
        {/* TIPS text */}
        <text x="40" y="22" fontFamily="Space Mono, monospace" fontSize="12" fontWeight="bold" fill="#2D4A1F" textAnchor="middle">
          TIPS
        </text>
